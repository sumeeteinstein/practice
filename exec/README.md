...
1. Data: This folder contain csv files for different parameters required to run Pfeature
2. example.seq : It is an example input file contain sequence of peptides (one sequence per line) 
3. example.out: An example output file corresponding to example.seq
4. Features_Table.pdf : File provides description of features in different columns in output file
5. lib: contain libraries required for package
6. pfeature_os : Executable file, where os is operating system like win, mac, ubuntu .
7. README : This file
